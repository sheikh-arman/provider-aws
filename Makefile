...
PROJECT_REPO ?= github.com/sheikh-arman/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 5.0.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-aws
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-aws_v5.0.1_x5
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/awss/01-delete.yaml.tmpl.
